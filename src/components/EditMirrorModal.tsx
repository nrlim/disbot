...
import { X, ChevronDown, Search, CheckCircle2, AlertTriangle, Loader2, Info, Terminal } from "lucide-react";
                                        ...
                                        <div className="relative">
                                            ...
                                            >
                                                {selectedGuild ? (
                                                    ...
                                                    <span className="text-zinc-600 text-sm font-mono">SELECT_SOURCE...</span>
                                                )}
