...
import { X, ChevronDown, Search, CheckCircle2, AlertTriangle, Loader2, Info, Terminal, ShieldAlert, Eye, EyeOff, Layers, FileText } from "lucide-react";
...
export default function EditMirrorModal({ isOpen, onClose, onSuccess, config }: EditMirrorModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (isBulkMode) {
            ...
            // Optional: allow selecting a default guild name via dropdown even in bulk mode, 
            // but for now we'll rely on the server validation or default.
                        ...
                        >
                            ...
                            <div className="p-8 overflow-y-auto space-y-8 bg-zinc-950">
                                ...
                                <form id="mirror-form" onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    {/* User Token - Common for both modes */}
                                    <div className="space-y-2">
                                        <div className="flex items-center justify-between">
                                            <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest font-mono">User Token {isBulkMode && "(Applied to All)"}</label>
                                            <button
                                                type="button"
